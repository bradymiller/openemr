     ...
     <input type="hidden" name="uniqueID" id="uniqueID" value = "<?php echo attr($uniqueID); ?>">
        ...
        foreach ($PMSFH[0] as $key => $value) {   
          ...
          $HELLO[attr($key)] = '<input type="radio" name="form_type" id="PMSFH_'.attr($key).'" value="'.attr($key).'" '.$checked.' onclick="top.restoreSession();newtype(\''.attr($key).'\');" /><span style="margin-top:2px;font-weight:bold;">'.
                          '<label class="input-helper input-helper--checkbox" for="PMSFH_'.attr($key).'" style="font-size:0.7em;">' . text($key_short_title) . '</label></span>&nbsp;';
         // ++$index;
        }
    ...
    <div class="borderShadow" style="text-align:left;margin-top:7px;width;98%;">
      ...
      <table id="row_social" width="100%">      
            ...
            <tbody>
                <tr>
                  ...
                  &nbsp;<?php echo xlt('Occupation'); ?>:&nbsp;<input type="text" style="width:175px;" name="occupation" id="occupation" value="<?php echo $patient['occupation']; ?>"></td>
                </tr>
                <tr>
                  <td></td>
                  <td colspan="2">
                  ...
                  <td class="text data" colspan="3">
                    <table cellpadding="0" cellspacing="0">
                      <tr>
                        ...
                        <td><input name="radio_tobacco" type="radio" id="radio_tobacco[not_applicable]" <?php if ($PMSFH[0]['SOCH']['tobacco']['restype'] =='not_applicable') echo "checked"; ?> value="not_applicabletobacco" onclick="smoking_statusClicked(this)">
                ...
                <tr>
                  ...
                  <tbody>
                    <tr>
                      ...
                      <td><input name="radio_coffee" type="radio" id="radio_coffee[not_applicable]" <?php if ($PMSFH[0]['SOCH']['coffee']['restype'] =='not_applicable') echo "checked"; ?> value="not_applicablecoffee" onclick="coffee_statusClicked(this)">
                        <i class="fa fa-history"></i>
                        </td>
                    </tr>
                  </tbody>
                    ...
                    <table cellpadding="0" cellspacing="0">
                      <tbody>
                        <tr><td><input type="text" name="form_alcohol" id="form_box" size="20" value="<?php echo attr($result2['alcohol']['resnote']); ?>">&nbsp;</td><td class="bold">&nbsp;&nbsp;</td><td class="text"><input type="radio" name="radio_alcohol" id="radio_alcohol[current]" value="currentalcohol" <?php if ($PMSFH[0]['SOCH']['alcohol']['restype'] =='currentalcohol') echo "checked"; ?>><?php echo xlt('Current'); ?>&nbsp;</td>
                          ...
                          <td><input name="radio_alcohol" type="radio" id="radio_alcohol[not_applicable]" value="not_applicablealcohol" <?php if ($PMSFH[0]['SOCH']['alcohol']['restype'] =='not_applicable') echo "checked"; ?> onclick="alcohol_statusClicked(this)">
                        <i class="fa fa-history"></i>
                        </td>
                        </tr>
                      </tbody>
                ...
                <tr>
                  <td class="label right"  nowrap><?php echo xlt('Drugs'); ?>:</td>
                  <td class="text data" colspan="3">
                    <table cellpadding="0" cellspacing="0">
                      <tbody>
                        <tr>
                          ...
                          <td><input name="radio_recreational_drugs" type="radio" id="radio_recreational_drugs[not_applicable]" <?php if ($PMSFH[0]['SOCH']['recreational_drugs']['restype'] =='not_applicable') echo "checked"; ?> value="not_applicablerecreational_drugs" onclick="recreational_drugs_statusClicked(this)">
                        <i class="fa fa-history"></i>
                      </td>
                        </tr>
                      </tbody>
                ...
                <tr class="nodisplay" ><td class="right"  nowrap><?php echo xlt('Counseling'); ?>:</td><td class="text data" colspan="3"><table cellpadding="0" cellspacing="0"><tbody><tr><td><input type="text" name="form_counseling" id="form_box" size="20" value="<?php echo attr($result2['counseling']['resnote']); ?>">&nbsp;</td><td class="bold">&nbsp;&nbsp;</td><td class="text"><input type="radio" name="radio_counseling" id="radio_counseling[current]" value="currentcounseling" <?php if ($PMSFH[0]['SOCH']['counseling']['restype'] =='currentcounseling') echo "checked"; ?>><?php echo xlt('Current'); ?>&nbsp;</td>
                  ...
                  <td><input name="radio_counseling" type="radio" id="radio_counseling[not_applicable]" value="not_applicablecounseling" <?php if ($PMSFH[0]['SOCH']['counseling']['restype'] =='not_applicable') echo "checked"; ?> onclick="counseling_statusClicked(this)">
                        <i class="fa fa-history"></i>
                  </td>
                </tr></tbody></table></td></tr>
            
                <tr><td class="right" nowrap><?php echo xlt('Exercise'); ?>:</td><td class="text data" colspan="3"><table cellpadding="0" cellspacing="0"><tbody><tr><td><input type="text" name="form_exercise_patterns" id="form_box" size="20" value="<?php echo attr($result2['exercise_patterns']['resnote']); ?>">&nbsp;</td><td class="bold">&nbsp;&nbsp;</td><td class="text"><input type="radio" name="radio_exercise_patterns" id="radio_exercise_patterns[current]" value="currentexercise_patterns" <?php if ($PMSFH[0]['SOCH']['exercise_patterns']['restype'] =='currentexercise_patterns') echo "checked"; ?>><?php echo xlt('Current'); ?>&nbsp;</td>
                  ...
                  <td><input name="radio_exercise_patterns" type="radio" id="radio_exercise_patterns[not_applicable]" <?php if ($PMSFH[0]['SOCH']['exercise_patterns']['restype'] =='not_applicable') echo "checked"; ?> value="not_applicableexercise_patterns" onclick="exercise_patterns_statusClicked(this)">
                        <i class="fa fa-history"></i>
                  </td>
                </tr></tbody></table></td></tr>
                
                <tr class="nodisplay"><td class="right"  nowrap><?php echo xlt('Hazardous Activities'); ?>:</td><td class="text data" colspan="3"><table cellpadding="0" cellspacing="0"><tbody><tr><td><input type="text" name="form_hazardous_activities" id="form_box" size="20" value="<?php echo attr($result2['hazardous_activities']['resnote']); ?>">&nbsp;</td><td class="bold">&nbsp;&nbsp;</td><td class="text"><input type="radio" name="radio_hazardous_activities" id="radio_hazardous_activities[current]" value="currenthazardous_activities" <?php if ($PMSFH[0]['SOCH']['hazardous_activities']['restype'] =='currenthazardous_activities') echo "checked"; ?>><?php echo xlt('Current'); ?>&nbsp;</td>
                  ...
                  <td><input name="radio_hazardous_activities" type="radio" id="radio_hazardous_activities[not_applicable]" <?php if ($PMSFH[0]['SOCH']['hazardous_activities']['restype'] =='not_applicable') echo "checked"; ?> value="not_applicablehazardous_activities" onclick="hazardous_activities_statusClicked(this)">
                        <i class="fa fa-history"></i>
                  </td>
                </tr></tbody></table></td></tr>
               
                <tr><td class="right"  nowrap><?php echo xlt('Sleep'); ?>:</td><td class="text data" colspan="3"><input type="text" name="form_sleep_patterns" id="form_box" size="20" title="<?php echo xla('Sleep patterns'); ?>" value="<?php echo attr($result2['sleep_patterns']['resnote']); ?>"></td></tr>
      ...
      <table id="row_FH" name="row_FH" width="90%">
        ...
        <tr>
          ...
          <td class="right" nowrap><?php echo xlt('Heart Problems'); ?>:</td>
          <td class="text data">
        ...
        <tr>
          ...
          <td class="text data">
            ...
            <input type="text" name="relatives_stroke" id="relatives_stroke" onclick='clear_option(this)' value="<?php echo $result1['relatives_stroke']; ?>"></td>
      ...
      <table id="row_ROS" name="row_ROS" width="95%" class="ROS_class">
        ...
        <tr>
          <td></td>
          <td>
            <span class="underline" style="padding:5px;"><?php echo xlt('Neg{{negative}}'); ?></span><span class="underline" style="margin:30px;"><?php echo xlt('Positive'); ?></span>
          </td>
          <td></td>
          <td><span class="underline" style="padding:5px;"><?php echo xlt('Neg{{negative}}'); ?></span><span class="underline" style="margin:30px;"><?php echo xlt('Positive'); ?></span>
          </td>
        </tr>
        <tr>
          <td class="label right" nowrap><?php echo xlt('General'); ?>:</td>
          <td>
          ...
          <td class="label right" nowrap><?php echo xlt('HEENT'); ?>:</td>
          <td>
        ...
        <tr>
          <td class="label right" nowrap><?php echo xlt('CV{{cardiovascular}}'); ?>:</td>
          <td>
          ...
          <td class="label right" nowrap><?php echo xlt('Pulmonary'); ?>:</td>
          <td>
        ...
        <tr>
          <td class="label right" nowrap><?php echo xlt('GI{{gastroenterology}}'); ?>:</td>
          <td>
          ...
          <td class="label right" nowrap><?php echo xlt('GU{{genitourinary}}'); ?>:</td>
          <td>
        ...
        <tr>
          <td class="label right" nowrap><?php echo xlt('Derm{{dematologic}}'); ?>:</td>
          <td>
          ...
          <td class="label right" nowrap><?php echo xlt('Neuro{{neurologic}}'); ?>:</td>
          <td>
        ...
        <tr>
          <td class="label right" nowrap><?php echo xlt('Psych{{psychiatric}}'); ?>:</td>
          <td>
          ...
          <td class="label right" nowrap><?php echo xlt('Musculo{{musculoskeletal}}'); ?>:</td>
          <td>
        ...
        <tr>
          <td class="label right" nowrap><?php echo xlt('Immuno{{immunologic}}'); ?>:</td>
          <td>
          ...
          <td class="label right" nowrap><?php echo xlt('Endocrine'); ?>:</td>
          <td>
