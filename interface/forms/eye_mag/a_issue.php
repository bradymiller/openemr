    ...
    <div class="borderShadow" style="text-align:left;margin-top:7px;width:95%;">
      <table  border='0' width='95%'>
        ...
        <tr id="row_title">
          ...
          <td  colspan="3">
            <input type='text' size='40' name='form_title' id='form_title' value='<?php echo attr($irow['title']) ?>' style='width:100%;text-align:left;' />
          </td>
        </tr>
        <tr id="row_diagnosis">
        ...
        <tr id='row_eye_med'>
          ...
          <td  colspan="3"><?php echo $irow['subtype']; ?>
            ...
            <?php if ($irow['subtype'] =='eye') echo "checked"; ?>
        ...
        <tr id='row_comments'>
          ...
          <td colspan="3">
           <textarea name='form_comments' id='form_comments' cols='40' wrap='virtual' style='margin-left:3px;width:100%'><?php echo text($irow['comments']) ?></textarea>
          </td>
        </tr>
        <tr id="row_outcome">
