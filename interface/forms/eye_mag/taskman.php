...
/**
 *
 *  Let's start by stating we are sending requests from somewhere in openEMR to fax something to someone somewhere.
 ...
 *		From, To, where to send it, who is receiving it, what to send (and thus how), Object(s) to send
 ...
 *  We know who the PCP is and the referring provider, who may or may not be the same person.
 *  Each request to fax the Object(s) in this iteration will be separate/unique.  
