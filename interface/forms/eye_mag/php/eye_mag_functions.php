...
function display_draw_section($zone,$encounter,$pid,$side ='OU',$counter='') {
    ...
    <div id="Draw_<?php echo attr($zone); ?>" name="Draw_<?php echo attr($zone); ?>" style="text-align:center;height: 2.5in;" class="Draw_class canvas">
        ...
        <div class="tools" style="text-align:center;width:100%;">
            <img id="sketch_tools_<?php echo attr($zone); ?>" onclick='$("#selColor_<?php echo attr($zone); ?>").val("blue");' src="../../forms/<?php echo $form_folder; ?>/images/pencil_blue.png" style="height:30px;width:15px;">
            <img id="sketch_tools_<?php echo attr($zone); ?>" onclick='$("#selColor_<?php echo attr($zone); ?>").val("#ff0");'  src="../../forms/<?php echo $form_folder; ?>/images/pencil_yellow.png" style="height:30px;width:15px;">
            <img id="sketch_tools_<?php echo attr($zone); ?>" onclick='$("#selColor_<?php echo attr($zone); ?>").val("#ffad00");' src="../../forms/<?php echo $form_folder; ?>/images/pencil_orange.png" style="height:30px;width:15px;">
            <img id="sketch_tools_<?php echo attr($zone); ?>" onclick='$("#selColor_<?php echo attr($zone); ?>").val("#AC8359");' src="../../forms/<?php echo $form_folder; ?>/images/pencil_brown.png" style="height:30px;width:15px;">
            <img id="sketch_tools_<?php echo attr($zone); ?>" onclick='$("#selColor_<?php echo attr($zone); ?>").val("red");' src="../../forms/<?php echo $form_folder; ?>/images/pencil_red.png" style="height:30px;width:15px;">
            <img id="sketch_tools_<?php echo attr($zone); ?>" onclick='$("#selColor_<?php echo attr($zone); ?>").val("#000");' src="../../forms/<?php echo $form_folder; ?>/images/pencil_black.png" style="height:50px;width:15px;">
            <img id="sketch_tools_<?php echo attr($zone); ?>" onclick='$("#selColor_<?php echo attr($zone); ?>").val("#fff");' src="../../forms/<?php echo $form_folder; ?>/images/pencil_white.png" style="height:30px;width:15px;">
             
            <span style="min-width:1in;">&nbsp;</span>
            <!-- now to pencil size -->
            <img id="sketch_sizes_<?php echo attr($zone); ?>" onclick='$("#selWidth_<?php echo attr($zone); ?>").val("1");' src="../../forms/<?php echo $form_folder; ?>/images/brush_1.png" style="height:20px;width:20px; border-bottom: 2pt solid black;">
            <img id="sketch_sizes_<?php echo attr($zone); ?>" onclick='$("#selWidth_<?php echo attr($zone); ?>").val("3");' src="../../forms/<?php echo $form_folder; ?>/images/brush_3.png" style="height:20px;width:20px;">
            <img id="sketch_sizes_<?php echo attr($zone); ?>" onclick='$("#selWidth_<?php echo attr($zone); ?>").val("5");' src="../../forms/<?php echo $form_folder; ?>/images/brush_5.png" style="height:20px;width:20px;">
            <img id="sketch_sizes_<?php echo attr($zone); ?>" onclick='$("#selWidth_<?php echo attr($zone); ?>").val("10");' src="../../forms/<?php echo $form_folder; ?>/images/brush_10.png" style="height:20px;width:20px;">
            <img id="sketch_sizes_<?php echo attr($zone); ?>" onclick='$("#selWidth_<?php echo attr($zone); ?>").val("15");' src="../../forms/<?php echo $form_folder; ?>/images/brush_15.png" style="height:20px;width:20px;">
        </div>
                ...
                <ul class="navbar-nav">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                            ...
                            <li id="menu_PRINT_narrative_2" name="menu_PRINT_report_2"><a id="BUTTON_PRINT_report_2" target="_new" href="<?php echo $GLOBALS['webroot']; ?>/interface/patient_file/report/custom_report.php?printable=1&pdf=1&<?php echo $form_folder."_".$form_id."=".$encounter; ?>"><?php echo xlt("Print/Store PDF"); ?></a></li>
                            <li class="divider"></li>
...
function menu_overhaul_left($pid,$encounter) {
    ...
    if (!$documents) list($documents) = document_engine($pid);
        ?>    
    <div class="borderShadow" style="font-size:1.0em;width:80%;display:inline-block;">
                ...
                <table style="text-align:left;">
                    ...
                    <tr><td class="right" >
                            ...
                            echo "<b>".xlt('Name').":</b> </td><td nowrap> &nbsp;".text($pat_data['fname'])."  ".text($pat_data['lname'])." (".text($pid).")</td></tr>
                                    <tr><td class='right'><b>".xlt('DOB').":</b></td><td  nowrap> &nbsp;".text($DOB). "&nbsp;&nbsp;(".text($age).")</td></tr>
                                    "; 
                            ?>
                            <?php 
                            ?>
...
function display_GlaucomaFlowSheet($pid,$bywhat='byday') {
    ...
    ?> <b> <?php echo xlt('Glaucoma Zone'); ?>:</b>
       ...
       <span class="closeButton fa fa-close" id="Close_IOP" name="Close_IOP"></span>
        ...
        <script src="<?php echo $GLOBALS['webroot']; ?>/library/js/Chart.js-master/dist/Chart.bundle.min.js"></script>
...
function findProvider($pid,$encounter) {
    ...
    if($providerid < '1') {
        ...
        if ((($new_providerid == '0')&&($new_providerid > '0'))||(!$new_providerid)) {
