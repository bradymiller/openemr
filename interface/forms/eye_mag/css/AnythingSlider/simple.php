                   ...
                   <!-- let's import the original openEMR menu_bar here.  Needs to add restoreSession stuff? -->
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu" role="menu">
                          ...
                          <!--
                                <li><?php echo '<a href="#" onclick="top.restoreSession();return dopopup(\''.$GLOBALS['webroot'].'/interface/forms/'.$form_folder.'/css/AnythingSlider/simple.php?display=i&category_id='.attr($documents['zones'][$category_value][$j]['id']).'&encounter='.attr($encounter).'&category_name='.urlencode($category_value).'\')">
