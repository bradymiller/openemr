...
('ANTSEG', 'c', 'CONJ', 2048, 'quiet', 11, NULL, 1),
('ANTSEG', 'c', 'CONJ', 2048, 'injection', 11, NULL, 2),
('ANTSEG', 'c', 'CONJ', 2048, 'pinquecula', 11, NULL, 4),
('ANTSEG', 'c', 'CONJ', 2048, 'papillae', 11, NULL, 3),
('ANTSEG', 'k', 'CORNEA', 2048, 'clear', 12, NULL, 1),
('ANTSEG', 'k', 'CORNEA', 2048, 'abrasion', 12, NULL, 2),
('ANTSEG', 'k', 'CORNEA', 2048, 'MDFP dystrophy', 12, NULL, 3),
('ANTSEG', 'k', 'CORNEA', 2048, 'metallic FB', 12, NULL, 4),
('ANTSEG', 'l', 'LENS', 2048, 'PXE', 14, NULL, 5),
('ANTSEG', 'a/c', 'AC', 2048, 'clear', 13, NULL, 1),
('ANTSEG', 'a/c', 'AC', 2048, 'F/C', 13, NULL, 3),
('ANTSEG', 'l', 'LENS', 2048, 'PSC', 14, NULL, 4),
('ANTSEG', 'a/c', 'AC', 2048, 'narrow', 13, NULL, 5),
('ANTSEG', 'l', 'LENS', 2048, 'NS', 14, NULL, 3),
('EXT', 'BROW', 'BROW', 2048, 'ptosis', 1, NULL, 1),
('EXT', 'BROW', 'BROW', 2048, 'rhytids', 1, NULL, 2),
('EXT', 'BROW', 'BROW', 2048, 'scar', 1, NULL, 4),
('EXT', 'UL', 'UL', 2048, 'dermatochalasis', 2, NULL, 1),
('EXT', 'UL', 'UL', 2048, '2mm ptosis', 2, NULL, 2),
('EXT', 'UL', 'UL', 2048, '3mm ptosis', 2, NULL, 3),
('EXT', 'UL', 'UL', 2048, 'lesion', 2, NULL, 4),
('EXT', 'LL', 'LL', 2048, 'lesion', 2048, NULL, 4),
('EXT', 'LL', 'LL', 2048, 'ectropion', 2048, NULL, 1),
('EXT', 'LL', 'LL', 2048, 'entropion', 2048, NULL, 2),
('EXT', 'LL', 'LL', 2048, 'trichiasis', 2048, NULL, 3),
('EXT', 'MCT', 'MCT', 2048, 'lesion', 4, NULL, 1),
('EXT', 'MCT', 'MCT', 2048, 'NLDO, acute', 4, NULL, 2),
('EXT', 'MCT', 'MCT', 2048, 'NLDO, chronic', 4, NULL, 3),
('ANTSEG', 'i', 'IRIS', 2048, 'post synchia', 15, NULL, 1),
('ANTSEG', 'i', 'IRIS', 2048, 'TI', 15, NULL, 2),
('ANTSEG', 'i', 'IRIS', 2048, 'PXE', 15, NULL, 3),
('ANTSEG', 'i', 'IRIS', 2048, 'PI', 15, NULL, 4),
('ANTSEG', 'c', 'CONJ', 2048, 'follicles', 11, NULL, 5),
('RETINA', 'p', 'PERIPH', 2048, 'NVE', 35, NULL, 5),
('RETINA', 'cup', 'CUP', 2048, '0.1', 31, NULL, 1),
('RETINA', 'cup', 'CUP', 2048, '0.3', 31, NULL, 2),
('RETINA', 'cup', 'CUP', 2048, '0.5', 31, NULL, 3),
('RETINA', 'cup', 'CUP', 2048, '0.8', 31, NULL, 4),
('RETINA', 'd', 'DISC', 2048, 'notch', 32, NULL, 1),
('RETINA', 'd', 'DISC', 2048, 'pallor', 32, NULL, 2),
('RETINA', 'd', 'DISC', 2048, 'NVD', 32, NULL, 3),
('RETINA', 'd', 'DISC', 2048, 'at risk', 32, NULL, 4),
('RETINA', 'm', 'MACULA', 2048, 'hard drusen', 33, NULL, 1),
('RETINA', 'm', 'MACULA', 2048, 'soft drusen', 33, NULL, 2),
('RETINA', 'm', 'MACULA', 2048, 'PED', 33, NULL, 3),
('RETINA', 'm', 'MACULA', 2048, 'CSR', 33, NULL, 4),
('RETINA', 'v', 'VESSELS', 2048, '1:2', 34, NULL, 1),
('RETINA', 'v', 'VESSELS', 2048, 'BDR', 34, NULL, 2),
('RETINA', 'v', 'VESSELS', 2048, 'PDR', 34, NULL, 3),
('RETINA', 'v', 'VESSELS', 2048, 'BRVO', 34, NULL, 4),
('RETINA', 'p', 'PERIPH', 2048, 'PVD', 35, NULL, 1),
('RETINA', 'p', 'PERIPH', 2048, 'VH', 35, NULL, 2),
('RETINA', 'p', 'PERIPH', 2048, 'tear', 35, NULL, 3),
('RETINA', 'p', 'PERIPH', 2048, 'schisis', 35, NULL, 4),
('RETINA', 'cup', 'CUP', 2048, '0.95', 31, NULL, 5),
('ANTSEG', 'c', 'CONJ', 2048, 'mucopurulence', 11, NULL, 7),
('ANTSEG', 'c', 'CONJ', 2048, 'pterygium', 11, NULL, 8),
('ANTSEG', 'c', 'CONJ', 2048, 'moderate bleb', 10, '0', 9),
('ANTSEG', 'c', 'CONJ', 2048, 'flat bleb', 10, '0', 8),
('ANTSEG', 'c', 'CONJ', 2048, 'pyogenic granuloma', 10, '0', 5),
('ANTSEG', 'c', 'CONJ', 2048, 'siedel negative', 10, '0', 10),
('ANTSEG', 'k', 'CORNEA', 2048, 'tight wound', 11, '0', 8),
('ANTSEG', 'k', 'CORNEA', 2048, 'stromal scar', 12, '0', 8),
('ANTSEG', 'a/c', 'AC', 2048, 'hyphema', 13, '0', 7),
('ANTSEG', 'a/c', 'AC', 2048, 'hypopion', 13, '0', 8),
('ANTSEG', 'k', 'CORNEA', 2048, 'edema', 12, NULL, 5),
('ANTSEG', 'k', 'CORNEA', 2048, 'striae', 12, NULL, 6),
('ANTSEG', 'k', 'CORNEA', 2048, 'mutton fat KP', 12, NULL, 7),
('ANTSEG', 'k', 'CORNEA', 2048, 'stellate KP', 12, NULL, 8),
('ANTSEG', 'l', 'LENS', 2048, 'PCIOL', 14, NULL, 5),
('ANTSEG', 'k', 'CORNEA', 2048, 'dendrite 	', 12, '0', 7),
('ANTSEG', 'i', 'IRIS', 2048, 'nevus', 15, NULL, 7),
('PREFS', 'EXAM', 'EXAM', 2048, 'EXAM', 57, 'QP', NULL),
('PREFS', 'VA', 'Vision', 2048, 'RS', 51, '1', 10),
('PREFS', 'CR', 'Cycloplegic Refracti', 2048, 'CR', 53, '0', 3),
('PREFS', 'MR', 'Manifest Refraction', 2048, 'MR', 54, '0', 2),
('NEURO', 'Color', 'COLOR', 2048, '11/11', 20, NULL, 1),
('NEURO', 'Color', 'COLOR', 2048, '15/15', 20, NULL, 2),
('NEURO', 'ACT', 'ACT', 2048, 'orthophoria', 21, NULL, 1),
('NEURO', 'ACT', 'ACT', 2048, 'flick X(T)', 21, NULL, 2),
('NEURO', 'ACT', 'ACT', 2048, '10 X(T)', 21, NULL, 3),
('NEURO', 'ACT', 'ACT', 2048, '15 X(T)', 21, NULL, 4),
('NEURO', 'ACT', 'ACT', 2048, '20 (XT)', 21, NULL, 5),
('NEURO', 'ACT', 'ACT', 2048, 'Flick E(T)', 21, NULL, 6),
('NEURO', 'ACT', 'ACT', 2048, '5 E(T)', 21, NULL, 7),
('NEURO', 'ACT', 'ACT', 2048, '10 E(T)', 21, NULL, 8),
('NEURO', 'ACT', 'ACT', 2048, '15 E(T)', 21, NULL, 9),
('NEURO', 'ACT', 'ACT', 2048, '20 E(T)', 21, NULL, 10),
('NEURO', 'ACT', 'ACT', 2048, 'flick RH(T)', 21, NULL, 11),
('NEURO', 'ACT', 'ACT', 2048, '2 RH(T)', 21, NULL, 12),
('NEURO', 'ACT', 'ACT', 2048, '4 RH(T)', 21, NULL, 13),
('NEURO', 'ACT', 'ACT', 2048, '6 RH(T)', 21, NULL, 14),
('NEURO', 'ACT', 'ACT', 2048, '8 RHT(T)', 21, NULL, 15),
('PREFS', 'CTL', 'Contact Lens', 2048, 'CTL', 55, '0', 4),
('PREFS', 'ADDITIONAL', 'Additional Data Points', 2048, 'ADDITIONAL', 56, '0', 5),
('PREFS', 'W', 'Current RX', 2048, 'W', 52, '0', 2),
('EXT', 'BROW', 'BROW', 2048, 'seb ker', 1, '0', 5),
('EXT', 'BROW', 'BROW', 2048, 'actinic keratosis', 1, '0', 6),
('EXT', 'BROW', 'BROW', 2048, 'BCC', 1, '0', 7),
('EXT', 'BROW', 'BROW', 2048, 'SCC', 1, '0', 8),
('EXT', 'MRD', 'MRD', 2048, '0', 1, '0', 10),
('EXT', 'MRD', 'MRD', 2048, '1', 1, '0', 11),
('EXT', 'MRD', 'MRD', 2048, '2', 1, '0', 12),
('EXT', 'MRD', 'MRD', 2048, '3', 1, '0', 13),
('EXT', 'LF', 'LF', 2048, '17', 1, '0', 14),
('EXT', 'LF', 'LF', 2048, '15', 1, '0', 15),
('EXT', 'LF', 'LF', 2048, '13', 1, '0', 16),
('EXT', 'LL', 'LL', 2048, 'fat prolapse', 2048, '0', 5),
('EXT', 'LL', 'LL', 2048, 'erythema', 2048, '0', 6),
('EXT', 'LL', 'LL', 2048, 'tenderness', 2048, '0', 9),
('EXT', 'LL', 'LL', 2048, 'chalazion', 2048, '0', 10),
('EXT', 'LL', 'LL', 2048, 'stye', 2048, '0', 11),
('EXT', 'UL', 'UL', 2048, 'chalazion', 2, '0', 5),
('EXT', 'UL', 'UL', 2048, 'stye', 2, '0', 6),
('PREFS', 'CLINICAL', 'CLINICAL', 2048, 'CLINICAL', 58, '0', 8),
('PREFS', 'REFRACTION', 'REFRACTION', 2048, '59', 8, '+', 9),
('PREFS', 'CYLINDER', 'CYL', 2048, 'CYL', 8, '+', 9),
('PREFS', 'EXT_VIEW', 'Mid Face', 2048, 'EXT_VIEW', 59, '1', NULL),
('PREFS', 'ANTSEG_VIEW', 'ANTSEG View', 2048, 'ANTSEG_VIEW', 60, '1', NULL),
('PREFS', 'RETINA_VIEW', 'Retina View', 2048, 'RETINA_VIEW', 60, '1', NULL),
('PREFS', 'NEURO_VIEW', 'Neuro View', 2048, 'NEURO_VIEW', 61, 'undefined', NULL),
...
('PREFS', 'IOP', 'Intraocular Pressure', 1, 'IOP',64, '0', 14),
('PREFS', 'ADDITIONAL', 'Additional Data Points', 1, 'ADDITIONAL', 56, '0', 6),
