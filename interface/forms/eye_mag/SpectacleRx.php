...
if ($_REQUEST['dispensed']) {
  ...
  ?><html>
    ...
    $filename = $pid."_".$encounter."_".rand().".pdf"; 
    ob_start();
                           ...
                           <?php
                                ...
                                if (file_exists($signature)) {
                                    ...
                                    <div style="position:relative;left:0.in;padding-left:40px;border-bottom:2pt solid black;width:50%;">
                                        <img src="<?php echo $GLOBALS['webroot']; ?>/interface/forms/eye_mag/images/sign_<?php echo attr($_SESSION['authUserID']); ?>.jpg" style="width:240px;height:85px;bottom:1px;" /> 
                                    </div>
                                </center>
                                    <?php } ?>
    ...
    echo $content; //display Rx to user, now store it too...
