                        ...
                        <tr>
                           ...
                           <?php
                                ...
                                if (file_exists($signature)) {
                                    ?>
                                    <span style="position:relative;padding-left:40px;border-bottom:2pt solid black;width:50%;">
                                        <img src='<?php echo $web_root; ?>/interface/forms/eye_mag/images/sign_<?php echo attr($_SESSION['authUserID']); ?>.jpg' style="width:240px;height:85px;bottom:1px;" /> 
                                    </span><br />
                          
                                    <?php } ?>

                        <?php echo xlt('Provider'); ?>: <?php echo text($prov_data['fname']); ?> <?php echo text($prov_data['lname']); ?><br />
