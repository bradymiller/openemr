			...
			<div id="accordion_general_group" name="accordion_group" class="ui-accordion" style="text-align:left;margin:10;padding:20;">
				...
				<div id="general" style="text-align:left;">
					<blockquote class="style2">
						...
						Using this method, all your findings are entered in one area as a list,
						and OpenEMR automatically knows how to store them.<hr />
						...
						Using just four lines of typing, one for each clinical section of the exam,<br /> 
						we will document all your normal findings <b>and more than 40 different clinical issues</b>: 
							<br />
						...
						<textarea class="kb_entry">D;CC:"My eyes are tearing and there is a yellow discharge";hpi:The symptoms began last week and the discharged turned yellow yesterday.  No photophobia.  The redness spread from the right to the left eye two days ago.;
						</textarea>
						<button id="HPI2">Details</button>
						<br />
						<h4 class="bold">PMH: </h4> 
						<textarea class="kb_entry">POH:Phaco/IOL OD 4/4/1994.Phaco/IOL OS 4/24/1995. Yag/PCO OD 6/5/1999;Meds:Timolol 0.5% GFS QHS OU. Latanoprost 0.01% QHS OU.
Trazadone 50mg PO QHS.Famvir 500mg PO TID;Surg:Appendectomy 1998. Choly 2010.Lap Band 2014.;All:sulfa - hives.PCN - SOB;
						</textarea>
						<button id="PMH2">Details</button>
						<br />
						...
						Voila, NPI, PMH, POH, Medications Allergies and 40 clinical findings + normals, are documented.  
						<hr />
						
						<textarea class="kb_entry" style="height:1in;">CC:"My eyes are tearing and there is a yellow discharge";hpi:The symptoms began last week and the discharged turned yellow yesterday.  No photophobia.  The redness spread from the right to the left eye two days ago.;
POH:Phaco/IOL OD 4/4/1994.Phaco/IOL OS 4/24/1995. Yag/PCO OD 6/5/1999;Meds:Timolol 0.5% GFS QHS OU. Latanoprost 0.01% QHS OU.
Trazadone 50mg PO QHS.Famvir 500mg PO TID;Surg:Appendectomy 1998. Choly 2010.Lap Band 2014.;All:sulfa - hives.PCN - SOB;
