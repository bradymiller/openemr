...
<html>
  ...
  <!-- jQuery library -->
	...
	<script src="<?php echo $GLOBALS['webroot'] ?>/library/css/jquery-ui-1.11.4.custom/jquery-ui.js"></script>
	<link rel="stylesheet" href="<?php echo $GLOBALS['webroot'] ?>/library/css/jquery-ui-1.11.4.custom/jquery-ui.css">
