...
/*
  Two windows anywhere with the same chart is not compatible with the autosave feature.
  ...
  If the form is LOCKED and the LOCKEDBY variable != uniqueID, a pop-up signals READ-ONLY mode.
...
<html>
  <head>
    ...
    function doscript(type,id,encounter,rx_number) {
      dlgopen('../../forms/eye_mag/SpectacleRx.php?REFTYPE=' + type + '&id='+id+'&encounter='+ encounter+'&form_id=<?php echo attr(addslashes($form_id)); ?>&rx_number='+rx_number, '_new', 660, 590);
    }
    ...
    function refractions(pid) {
      dlgopen('../../forms/eye_mag/refractions.php?dispensed=1&pid='+pid, '_new', 560, 590);
    }
    ...
    function sel_diagnosis(target,term) {
      ...
      {
        ?>
      dlgopen('../../patient_file/encounter/find_code_popup.php?codetype=<?php echo attr(collect_codetypes("medical_problem","csv")) ?>&search_term='+escape(term), '_blank', 500, 400);
        <?php
      } else{
        ?>
      dlgopen('../../patient_file/encounter/find_code_popup.php?codetype=<?php echo attr(collect_codetypes("diagnosis","csv")) ?>&search_term='+escape(term), '_blank', 500, 400);
        <?php
      }
      ?>
  }
...
//also add in any obj.Clinical data if the form was already opened
  ...
  <script>
    obj.Clinical = [<?php echo json_encode($codes_found[0]); ?>];
      ...
      <link rel="stylesheet" href="<?php echo $GLOBALS['webroot'] ?>/library/css/jquery-ui-1.8.21.custom.css">
...
?><br /><br />
    ...
    <div id="page-wrapper" style="margin: 0px 0px 0px 0px;text-align:center;">
      ...
      <div id="Layer3" name="Layer3" class="container-fluid" style="text-align:center;padding:0px 30px;">
        ...
        if ($display =="fullscreen") {  
          ...
          $PLAN_today = preg_replace("/\|/","<br />",$priors[$earlier]['PLAN']);
                ...
                <table style="text-align:left;margin:auto;">
                  <tr>
                    ...
                    <td style="vertical-align:top;" nowrap>
                      <?php
                      if ($reason['pc_hometext']) echo $reason['pc_hometext']. "<br />"; 
                      if ($PLAN_today) echo $PLAN_today;
                      ?>
                    </td>
                  </tr>
                </table>
          ...
          <div id="Layer1" name="Layer1" class="display">
            ...
            <div class="body_top text-center row" id="form_container" name="form_container">
                  ...
                  <div id="HPI_1" name="HPI_1" class="<?php echo attr($display_Add); ?>">
                    ...
                    <div id="HPI_left" name="HPI_left" class="exam_section_left borderShadow">
                      <div id="HPI_left_text" class="TEXT_class" style="height: 315px;text-align:left;" >
                        <span class="closeButton fa fa-paint-brush" title="<?php echo xla('Open the HPI Canvas'); ?>" id="BUTTON_DRAW_HPI" name="BUTTON_DRAW_HPI"></span>
                        <i class="closeButton_2 fa fa-database" title="<?php echo xla('Open the detailed HPI panel'); ?>" id="BUTTON_QP_HPI" name="BUTTON_QP_HPI"></i>  
                  ...
                  <div id="PMH_1" name="PMH_1" class="<?php echo attr($display_Add); ?> clear_both">
                    ...
                    <div id="PMH_left" name="PMH_left" class="exam_section_left borderShadow">
                      <div id="PMH_left_text" style="height: 2.5in;text-align:left;" class="TEXT_class">
                        ...
                        <span class="closeButton_2 fa fa-paint-brush" title="<?php echo xla('Open the PMH draw panel'); ?>" id="BUTTON_DRAW_PMH" name="BUTTON_DRAW_PMH"></span>
                        <i class="closeButton_3 fa fa-database" title="<?php echo xla('Open the PMSFH summary panel'); ?>" id="BUTTON_QP_PMH" name="BUTTON_QP_PMH"></i>
              ...
              <div class="clear_both row" style="display: inline-block;margin:10px auto;" id="LayerTechnical_sections_1" name="LayerTechnical_sections" >
                ...
                <div id="LayerMood" class="vitals" style="width: 146px; min-height: 1.05in;border: 1.00pt solid #000000;text-align:left;padding-left:10px;float:left;">
                ...
                <div id="LayerVision" class="vitals" style="width: 2.0in; min-height: 1.05in;padding: 0.02in; border: 1.00pt solid #000000;float:left;">
                  ...
                  <div class="top_right">
                          <span id="tabs" style="font-size:0.5em;">  
                              <ul>
                                  ...
                                  <li id="LayerVision_VAX_lightswitch" class="<?php echo attr($button_VAX); ?>" value="Visual Acuities"><?php echo xlt('Va{{Visual Acuities}}'); ?></li>                           
                              </ul>
                          </span>
                  </div>    
                  ...
                  <div id="Visions_A" name="Visions_A" class="" style="position: absolute; top: 0.35in; text-align:right;right:0.1in; height: 0.72in;  padding: 0in;" >
                      ...
                      <span style="position: absolute;top:0.41in;left:0.33in;font-size: 0.8em;"><b><?php echo xlt('SC{{without correction}}'); ?></b></span>
                      <span style="position: absolute;top:0.41in;left:0.68in;font-size: 0.8em;"><b><?php echo xlt('CC{{with correction}}'); ?></b></span>
                      <span style="position: absolute;top:0.41in;left:1.10in;font-size: 0.8em;"><b><?php echo xlt('PH{{pinhole acuity}}'); ?></b></span><br /><br /><br />
                  </div>
                  <div id="Visions_B" name="Visions_B" class="nodisplay" style="position: absolute; top: 0.35in; text-align:right;right:0.1in; height: 0.72in;  padding: 0in;" >
                      ...
                      <span style="position: absolute;top:0.41in;left:0.33in;font-size: 0.8em;"><b><?php echo xlt('AR{{Autorefraction Acuity}}'); ?></b></span>
                      <span style="position: absolute;top:0.41in;left:0.68in;font-size: 0.8em;"><b><?php echo xlt('MR{{Manifest refraction}}'); ?></b></span>
                      <span style="position: absolute;top:0.41in;left:1.10in;font-size: 0.8em;"><b><?php echo xlt('CR{{Cycloplegic refraction}}'); ?></b></span>
                  </div>       
                </div>
                ...
                <div id="LayerTension" class="vitals" style="width: 1.5in; height: 1.05in;padding: 0.02in; border: 1.00pt solid #000000;float:left;">
                      ...
                      <div id="Lyr4.2" style="position: absolute; top: 0.35in; text-align:right;right:0.1in; height: 0.72in;  padding: 0in; border: 1pt black;">
                          ...
                          <br /><br />
                          <span style="position: absolute;top:0.44in;left:0.22in;font-size: 0.8em;"><b><?php echo xlt('AP{{applanation}}'); ?></b></span>
                          <span style="position: absolute;top:0.44in;left:0.47in;font-size: 0.8em;"><b><?php echo xlt('TP{{tonopen}}'); ?></b></span>
                          <span style="position: absolute;top:0.44in;left:0.7in;font-size: 0.8em;"><b><?php echo xlt('FT{{finger tension}}'); ?></b></span>
                      </div>
                </div>
              ...
              <div id="REFRACTION_sections" name="REFRACTION_sections" class="row nodisplay clear_both" style="position:relative;display:inline-block;margin:10px auto;max-width:90%;">
                               ...
                               <!-- start IOP chart section -->
                                ...
                                <div id="LayerVision_IOP" class="borderShadow <?php echo $display_IOP; ?>">
                                    <span class="closeButton fa fa-close" id="Close_IOP" name="Close_IOP"></span>
                                     <table id="iopgraph" name "iopgraph" style="min-width:600px;">
                                        <h4> <?php echo xlt('Placeholder: plot pressures over time'); ?></h4>
                                     </table>
                                </div>
                                ...
                                <div id="LayerVision_W" class="<?php echo $display_W; ?>" style="display:inline-block;">
                                  ...
                                  <div id="LayerVision_W_1" class="refraction current_W borderShadow">
                                    <i class="closeButton fa fa-close" id="Close_W_1" name="Close_W_1" title="<?php echo attr('Close and make this a Preference to stay closed'); ?>"></i>
                                  ...
                                  <div id="LayerVision_W_2" class="refraction current_W borderShadow <?php echo attr($display_W_2); ?>">
                                    <i class="closeButton fa fa-close" id="Close_W_2" name="Close_W_2" title="<?php echo attr('Close Current RXs and make this a Preference to stay closed'); ?>"></i>
                                  ...
                                  <div id="LayerVision_W_3" class="refraction current_W borderShadow <?php echo attr($display_W_3); ?>">
                                    <i class="closeButton fa fa-close" id="Close_W_3" name="Close_W_3" title="<?php echo attr('Close Current RXs and make this a Preference to stay closed'); ?>"></i>
                                  ...
                                  <div id="LayerVision_W_4" class="refraction current_W borderShadow <?php echo attr($display_W_4); ?>">
                                    <i class="closeButton fa fa-close" id="Close_W_4" name="Close_W_4" title="<?php echo attr('Close Current RXs and make this a Preference to stay closed'); ?>"></i>
                                ...
                                <div id="LayerVision_MR" class="refraction manifest borderShadow <?php echo $display_AR; ?>">
                                    <span class="closeButton fa  fa-close" id="Close_MR" name="Close_MR" title="<?php echo attr('Close and make this a Preference to stay closed'); ?>"></span>
                                     <i onclick="top.restoreSession();  refractions('<?php echo attr($pid); ?>');return false;" 
                                       title="<?php echo attr("List of previous refractions"); ?>" class="closeButton3 fa fa-list-ul"></i>
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                          ...
                                          <td colspan="6" style="text-align:left;">
                                            <textarea style="width:95%;height:20px;" name="CTL_COMMENTS" id="CTL_COMMENTS" rows="1" tabindex="250"><?php echo text($CTL_COMMENTS); ?></textarea>
                                          </td>
                                        </tr>
                                    </table>
                                </div>
                                ...
                                <div id="LayerVision_ADDITIONAL" class="refraction borderShadow <?php echo $display_Add; ?>">
                                    ...
                                    <table id="Additional">
                                        ...
                                        <tr><td></td>
                                            <td><?php echo xlt('PH{{pinhole acuity}}'); ?></td>
                                            <td><?php echo xlt('PAM{{Potential Acuity Meter}}'); ?></td>
                                            <td><?php echo xlt('LI{{Laser Interferometry Acuity}}'); ?></td>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo xlt('PD{{pupillary diameter}}'); ?></td>
                                ...
                                <div id="LayerVision_VAX" class="refraction borderShadow <?php echo $display_Add; ?>">
                                    ...
                                    <table id="Additional_VA">
                                        ...
                                        <tr><td></td>
                                            ...
                                            <td><?php echo xlt('W Rx{{with glasses on}}'); ?></td>
                                            ...
                                            <td><?php echo xlt('PH{{pinhole acuity}}'); ?></td>
                                            <td><?php echo xlt('CTL{{contact lens}}'); ?></td>
                                        ...
                                        <tr>
                                            <td></td>
                                            <td><?php echo xlt('scNear{{without correct at near}}'); ?></td>
                                            <td><?php echo xlt('ccNear{{with corrction at near}}'); ?></td>
                                            <td><?php echo xlt('ARNear{{autorefraction near}}'); ?></td>
                                            <td><?php echo xlt('MRNear{{maifest refraction near}}'); ?></td>
                                            <td><?php echo xlt('PAM{{Potential Acuity Meter}}'); ?></td>
                                            <td><?php echo xlt('BAT{{Brightness Acuity Testing}}'); ?></td>
              ...
              <div style="margin: 0 auto;text-align: center;display:inline-table;max-width: 95%;" class="nodisplay" id="DA_EXAM_sections" name="DA_EXAM_sections">   
                ...
                <div id="EXT_1" name="EXT_1" class="clear_both">
                  ...
                  <div id="EXT_left" class="exam_section_left borderShadow" >
                    <div id="EXT_left_text" style="height: 2.5in;text-align:left;" class="TEXT_class">
                      <span class="closeButton fa fa-paint-brush" title="<?php echo xla('Open the External drawing panel'); ?>" id="BUTTON_DRAW_EXT" name="BUTTON_DRAW_EXT"></span>
                      <i class="closeButton_2 fa fa-database" title="<?php echo xla('Open the External Exam Quick Picks panel'); ?>" id="BUTTON_QP_EXT" name="BUTTON_QP_EXT"></i>
                      <i class="closeButton_3 fa fa-user-md fa-sm fa-2" name="Shorthand_kb" title="<?php echo xla("Open the Shorthand Window and display Shorthand Codes"); ?>"></i>
                  ...
                  <div id="EXT_right" name="EXT_right" class="exam_section_right borderShadow text_clinical">
                      ...
                      <div id="QP_EXT" name="QP_EXT" class="QP_class" style="text-align:left;max-height: 2.5in;">
                          ...
                          <div id="EXT_QP_block1" name="EXT_QP_block1" class="QP_block borderShadow text_clinical" >
                              ...
                              $number_rows=0;
                              if (sqlNumRows($result) < '1') { //for new users, use default quick picks until a pref list is developed
                              ...
                              while ($Select_data= sqlFetchArray($result))   {
                                  ...
                                  ?>
                                  <a class="underline QP" onclick="fill_QP_field('EXT','R','<?php echo attr($Select_data['LOCATION_text']); ?>','<?php echo attr($Select_data['selection']); ?>','<?php echo attr($Select_data['FILL_ACTION']); ?>');"><?php echo xlt('R{{right}}'); ?></a> | 
                                  <a class="underline QP" onclick="fill_QP_field('EXT','L','<?php echo attr($Select_data['LOCATION_text']); ?>','<?php echo attr($Select_data['selection']); ?>','<?php echo attr($Select_data['FILL_ACTION']); ?>');"><?php echo xlt('L{{left}}'); ?></a> | 
                                  <a class="underline QP" onclick="fill_QP_field('EXT','R','<?php echo attr($Select_data['LOCATION_text']); ?>','<?php echo attr($Select_data['selection']); ?>','<?php echo attr($Select_data['FILL_ACTION']); ?>');fill_QP_field('EXT','L','<?php echo attr($Select_data['LOCATION_text']); ?>','<?php echo attr($Select_data['selection']); ?>','<?php echo attr($Select_data['FILL_ACTION']); ?>');"><?php echo xlt('B{{bilateral}}'); ?></a> </span>
                ...
                <div id="ANTSEG_1" class="clear_both">
                  ...
                  <div id="ANTSEG_left" name="ANTSEG_left" class="exam_section_left borderShadow">
                    <div class="TEXT_class" id="ANTSEG_left_text" style="height: 2.5in;text-align:left;">
                      <span class="closeButton fa fa-paint-brush" title="<?php echo xla('Open the Anterior Segment drawing panel'); ?>" id="BUTTON_DRAW_ANTSEG" name="BUTTON_DRAW_ANTSEG"></span>
                      <i class="closeButton_2 fa fa-database"title="<?php echo xla('Open the Anterior Segment Exam Quick Picks panel'); ?>" id="BUTTON_QP_ANTSEG" name="BUTTON_QP_ANTSEG"></i>
                      <i class="closeButton_3 fa fa-user-md fa-sm fa-2" name="Shorthand_kb" title="<?php echo xla("Open the Shorthand Window and display Shorthand Codes"); ?>"></i>
                              ...
                              <table style="text-align:center;font-size:1.0em;width:170px;padding-left:5px;"> 
                                  ...
                                  <tr style="padding-bottom:15px;">
                                      <td class="right" title="<?php echo xla('Tear Break Up Time'); ?>">
                                        <div class="kb kb_left"><?php echo xla('R/LTBUT{{right left Tear Break Up Time}}'); ?>R/LTBUT</div>
                             ...
                             <?php
                                ...
                                while ($Select_data= sqlFetchArray($result))   {
                                  ...
                                  $string = $Select_data['selection'] ;
                                   ...
                                   ?> <span>
                                  <a class="underline QP" onclick="fill_QP_field('ANTSEG','OD','<?php echo attr($Select_data['LOCATION_text']); ?>','<?php echo attr($Select_data['selection']); ?>','<?php echo attr($Select_data['FILL_ACTION']); ?>');"><?php echo xlt('OD{{right eye}}'); ?></a> | 
                                  <a class="underline QP" onclick="fill_QP_field('ANTSEG','OS','<?php echo attr($Select_data['LOCATION_text']); ?>','<?php echo attr($Select_data['selection']); ?>','<?php echo attr($Select_data['FILL_ACTION']); ?>');"><?php echo xlt('OS{{left eye}}'); ?></a> | 
                                  <a class="underline QP" onclick="fill_QP_field('ANTSEG','OD','<?php echo attr($Select_data['LOCATION_text']); ?>','<?php echo attr($Select_data['selection']); ?>','<?php echo attr($Select_data['FILL_ACTION']); ?>');fill_QP_field('ANTSEG','OS','<?php echo attr($Select_data['LOCATION_text']); ?>','<?php echo attr($Select_data['selection']); ?>','<?php echo attr($Select_data['FILL_ACTION']); ?>');"><?php echo xlt('OU{{both eyes}}'); ?></a> </span>
                                  &nbsp;    <?php echo text($Select_data['LOCATION']); ?>: <?php echo text($string); ?>
                ...
                <div id="RETINA_1" class="clear_both" >
                  ...
                  <div id="RETINA_left" name="RETINA_left" class="exam_section_left borderShadow">
                    <div class="TEXT_class" id="RETINA_left_text" name="RETINA_left_text" style="height: 2.5in;text-align:left;"> 
                      ...
                      -->
                      <span class="closeButton fa fa-paint-brush" title="<?php echo xla('Open the Retina drawing panel'); ?>" id="BUTTON_DRAW_RETINA" name="BUTTON_DRAW_RETINA"></span>
                      <i class="closeButton_2 fa fa-database"title="<?php echo xla('Open the Retinal Exam Quick Picks panel'); ?>" id="BUTTON_QP_RETINA" name="BUTTON_QP_RETINA"></i>
                      <i class="closeButton_3 fa fa-user-md fa-sm fa-2" name="Shorthand_kb" title="<?php echo xla("Open the Shorthand Window and display Shorthand Codes"); ?>"></i>
                    ...
                    <div id="QP_RETINA" name="QP_RETINA" class="QP_class" style="text-align:left;height: 2.5in;">
                      ...
                      <div class="QP_block borderShadow text_clinical" >
                          <?php
                              ...
                              ?>
                          <span>
                              <a class="underline QP" onclick="fill_QP_field('RETINA','OD','<?php echo attr($Select_data['LOCATION_text']); ?>','<?php echo attr($Select_data['selection']); ?>','<?php echo attr($Select_data['FILL_ACTION']); ?>');"><?php echo xlt('OD{{right eye}}'); ?></a>&nbsp;|&nbsp;
                              <a class="underline QP" onclick="fill_QP_field('RETINA','OS','<?php echo attr($Select_data['LOCATION_text']); ?>','<?php echo attr($Select_data['selection']); ?>','<?php echo attr($Select_data['FILL_ACTION']); ?>');"><?php echo xlt('OS{{left eye}}'); ?></a>&nbsp;|&nbsp;
                              <a class="underline QP" onclick="fill_QP_field('RETINA','OD','<?php echo attr($Select_data['LOCATION_text']); ?>','<?php echo attr($Select_data['selection']); ?>','<?php echo attr($Select_data['FILL_ACTION']); ?>');fill_QP_field('RETINA','OS','<?php echo attr($Select_data['LOCATION_text']); ?>','<?php echo attr($Select_data['selection']); ?>','<?php echo attr($Select_data['FILL_ACTION']); ?>');"><?php echo xlt('OU{{both eyes}}'); ?></a>
                              &nbsp;    <?php echo text($Select_data['LOCATION']); ?>: <?php echo text($string); ?>
                ...
                <div id="NEURO_1" class="clear_both">
                  ...
                  <div id="NEURO_left" class="exam_section_left borderShadow">
                        <span class="closeButton fa fa-paint-brush" id="BUTTON_DRAW_NEURO" title="<?php echo xla('Open the Neuro drawing panel'); ?>" name="BUTTON_DRAW_NEURO"></span>
                        <i class="closeButton_2 fa fa-database" title="<?php echo xla('Open the Neuro Exam Quick Picks panel'); ?>" id="BUTTON_QP_NEURO" name="BUTTON_QP_NEURO"></i>
                ...
                <div id="IMPPLAN_1" class="clear_both"> 
                  ...
                  <div id="IMPPLAN_left" name="IMPPLAN_left" class="exam_section_left borderShadow">
                    <a class="closeButton_4" title="<?php echo xla('Once completed, view and store this encounter as a PDF file'); ?>" target="_report" href="/openemr/interface/patient_file/report/custom_report.php?printable=1&pdf=1&<?php echo $form_folder."_".$form_id."=".$encounter; ?>&"><i class="fa fa-file-pdf-o"></i></a>
                    <span class="closeButton fa fa-paint-brush" id="BUTTON_DRAW_IMPPLAN" title="<?php echo xla('Open the Imp/Plan drawing panel'); ?>"  name="BUTTON_DRAW_IMPPLAN"></span>
                    <i class="closeButton_2 fa fa-database" title="<?php echo xla('Open the Impression/Plan Builder panel'); ?>" id="BUTTON_QP_IMPPLAN" name="BUTTON_QP_IMPPLAN"></i>
                    <i class="closeButton_3 fa fa-user-md fa-sm fa-2" name="Shorthand_kb" title="<?php echo xla("Open the Shorthand Window and display Shorthand Codes"); ?>"></i>
                 ...
                 <?php
                  ...
                  <div id="IMPPLAN_right" class="exam_section_right borderShadow text_clinical">
                    ...
                    <div id="QP_IMPPLAN" name="QP_IMPPLAN" class="QP_class" style="text-align:left;min-height: 2.5in;padding-right:20px;padding-left:20px;">
                      ...
                      */
                      $query = "select * from list_options where list_id like 'Provider_todo_".$providerID."' order by seq";
                      ...
                      if (!$maxTODO) {  
                        ...
                        $query = "INSERT INTO `openemr`.`list_options` (`list_id`, `option_id`, `title`, `seq`, `is_default`, `option_value`, `mapping`, `notes`, `codes`) VALUES
                          ('Provider_todo_".$providerID."', 'VF', 'Visual Field', '1', '0', '0', '', '', '92083'),
                          ('Provider_todo_".$providerID."', 'ExtPhoto', 'External Photos', '2', '0', '0', '', '', '92285'),
                          ('Provider_todo_".$providerID."', 'OCTDisc', 'OCT Disc', '3', '0', '0', '', '', '92133'),
                          ('Provider_todo_".$providerID."', 'OCTRetina', 'OCT Retina', '4', '0', '0', '', '', '92134'),
                          ('Provider_todo_".$providerID."', 'FundusPhoto', 'Retina Photo', '5', '0', '0', '', '', '92250'),
                          ('Provider_todo_".$providerID."', 'Topo', 'Corneal Topography', '6', '0', '0', '', '', '92025'),
                          ('Provider_todo_".$providerID."', 'Gonio', 'Gonio', '7', '0', '0', '', '', '92020'),
                          ('Provider_todo_".$providerID."', 'Pachy', 'Pachymetry', '8', '0', '0', '', '', '76514')";
                          sqlStatement($query);
                      ...
                      <dt class="borderShadow">
                        ...
                        <a href="/openemr/interface/super/edit_list.php?list_id=Provider_todo_<?php echo attr($providerID); ?>" target="RTop" 
                      ...
                      <dd>
                          ...
                          <tr>
                            <td style="padding-right:20px;padding-left:20px;">
                              ...
                              $query = "select * from list_options where list_id like 'Provider_todo_".text($providerID)."' order by seq";
                              $TODO_data =sqlStatement($query);
                              $count=0;
                              $counter=0;
                              ...
                              while ($row = sqlFetchArray($TODO_data)) {
                               ...
                               // <!-- <i title="Build your plan." class="fa fa-share-square-o fa-flip-horizontal" id="make_new_PLAN" name="make_new_PLAN"></i>--> 
                                echo "<input type='checkbox' id='PLAN$counter' name='PLAN[]' $checked value='<?php echo attr($row[title]); ?>'> ";
                      ...
                      <dd>
                        <div style="padding:5px 20px 5px 20px;">
                          <table style="width:100%;">
                            ...
                            <tr>
                              <td style="padding-top:5px;" colspan="3"><b><?php echo xlt('Testing'); echo " ".xlt('Codes'); ?>:</b>&nbsp;
                                <a href="/openemr/interface/super/edit_list.php?list_id=Provider_todo_<?php echo attr($providerID); ?>" target="RTop" 
                          ...
                          <tr>
                            <td colspan="3">
                              ...
                              $query = "select * from list_options where list_id = 'Provider_todo_".attr($providerID)."' GROUP by codes order by seq ";
                              $TODO_data =sqlStatement($query);
                              $counter='0';
                              $count='0';
                              ...
                              while ($row = sqlFetchArray($TODO_data)) {
                                ...
                                $label = text(substr($codedesc,0,30));
    ...
    <div id="right-panel" name="right-panel" class="panel_side">
      <div style="margin-top:20px;text-align:center;font-size:1.2em;">
        <span class="fa fa-file-text-o" title="<?php echo xla('Show only the Text panels'); ?>" id="PANEL_TEXT" name="PANEL_TEXT" style="margin:2px;"></span>
        <span class="fa fa-database" title="<?php echo xla('Open All of the Quick Pick panels'); ?>" id="PANEL_QP" name="PANEL_QP" style="margin:2px;"></span>
        <span class="fa fa-paint-brush" title="<?php echo xla('Open the Draw panels'); ?>" id="PANEL_DRAW" name="PANEL_DRAW" style="margin:2px;"></span>
        ...
        <span class="fa fa-close" title="<?php echo xla('Close this panel'); ?>" id="close-panel-bt" style="margin:2px;"></span>
      </div>
