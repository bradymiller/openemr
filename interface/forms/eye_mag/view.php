...
<html>
  <head>
    ...
    <script src="<?php echo $GLOBALS['webroot'] ?>/library/js/bootstrap.min.js"></script>  
      ...
      <![endif]-->
      <!-- have to bring this into library/code base 1.8.21.custom.min.js has draggable/droppable in it -->
    <script src="<?php echo $GLOBALS['webroot'] ?>/library/js/qtip-2.0/jquery.qtip.min.js"></script>
    ...
    <link rel="stylesheet" href="<?php echo $GLOBALS['webroot'] ?>/library/js/qtip-2.0/jquery.qtip.min.css" />
  ...
  <body class="bgcolor2" background="<?php echo $GLOBALS['backpic']?>" style="padding:0;margin:0;" topmargin=0 rightmargin=0 leftmargin=0 bottommargin=0 marginwidth=0 marginheight=0>
          ...
          <div id="Layer1" name="Layer1" class="display">
            ...
            <div class="body_top text-center row" id="form_container" name="form_container">
              ...
              <div id="first" name="first" class="text_clinical" style="display:inline-block;width:90%;">
                ...
                <!-- start    HPI_PMH row -->
                <div id="HPIPMH_sections" name="HPIPMH_sections" style="display:inline-block;margin: 10 auto;text-align:center;" class="nodisplay" >   
                  <!-- start    HPI_section -->
             ...
             <?php ($IOP ==1) ? ($display_IOP = "") : ($display_IOP = "nodisplay"); ?>
              ...
              <div id="REFRACTION_sections" name="REFRACTION_sections" class="row nodisplay clear_both" style="position:relative;display:inline-block;margin:5px auto;max-width:90%;">
    ...
    <script type="text/javascript" src="<?php echo $GLOBALS['webroot']; ?>/interface/forms/<?php echo $form_folder; ?>/js/eye_base.php?enc=<?php echo attr($encounter); ?>"></script>
    ...
    <script src="<?php echo $GLOBALS['webroot'] ?>/library/js/jquery-ui-1.11.4/jquery-ui.min.js"></script>
