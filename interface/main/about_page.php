...
?>
 <html>
  ...
  <body class="body_top">
   ...
   <a href="http://open-emr.org/wiki/index.php/OpenEMR_4.2.1_Users_Guide" target="_blank" class="css_button" style="text-align:center"><span><?php echo xlt('User Manual'); ?></span></a><br><br>
