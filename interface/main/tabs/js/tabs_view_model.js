...
function tabStatus(title,url,name,label,closable,visible,locked)
{
    ...
    self.loading_text=ko.observable(((xl("Loading") !== undefined) ? xl("Loading") : "Loading") + " " + ((xl(label) !== undefined) ? xl(label) : label) + "...");
...
function tabs_view_model()
{
    ...
    this.tabsList.push(new tabStatus(((xl("Loading") !== undefined) ? xl("Loading") : "Loading") + "<a style='font-size:80%'><i class='fa fa-spinner fa-pulse'></i></a>",webroot_url+"/interface/main/main_info.php","cal","Calendar",true,true,false));
    this.tabsList.push(new tabStatus(((xl("Loading") !== undefined) ? xl("Loading") : "Loading") + "<a style='font-size:80%'><i class='fa fa-spinner fa-pulse'></i></a>",webroot_url+"/interface/main/messages/messages.php?form_active=1","msg","Messages",true,false,false));
