...
CREATE TABLE `assessments` (
  ...
  `deadline` date NOT NULL COMMENT 'deadline to complete the form, will be used when sending notification and reminders',
  ...
  `updated_at` datetime NOT NULL COMMENT 'timestamp recording the updated time of this assessment, this field indicates the completion time when the status is completed',
  PRIMARY KEY (`id`)
