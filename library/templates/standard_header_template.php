...
<?php } ?>
<?php if (!empty($include_standard_style_js) && in_array("sidebar",$include_standard_style_js)) { ?>
...
<?php } ?>
<?php if (!empty($include_standard_style_js) && in_array("esign",$include_standard_style_js)) { ?>
    <link rel="stylesheet" href="<?php echo $GLOBALS['webroot'] ?>/library/ESign/css/esign.css">
<?php } ?>
...
<?php } ?>
<?php if (!empty($include_standard_style_js) && in_array("esign",$include_standard_style_js)) { ?>
    <script type="text/javascript" src="<?php echo $GLOBALS['webroot'] ?>/library/ESign/js/jquery.esign.js"></script>
<?php } ?>
...
<?php } ?>
<?php if (!empty($include_standard_style_js) && in_array("openflashchart",$include_standard_style_js)) { ?>
    <script type="text/javascript" src="<?php echo $GLOBALS['webroot'] ?>/library/openflashchart/js/json/json2.js"></script>
    <script type="text/javascript" src="<?php echo $GLOBALS['webroot'] ?>/library/openflashchart/js/swfobject.js"></script>
<?php } ?>
